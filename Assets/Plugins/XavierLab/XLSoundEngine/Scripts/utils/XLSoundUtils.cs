...
namespace XavierLab
{
    public static class XLSoundUtils
    {
        ...
        public static Texture2D PaintWaveformSpectrum(AudioClip audio, int width, int height, Color col)
        {
            ...
            var h1 = height * 0.75f;
            var h2 = (int)(height * 0.5f);

            for (int x = 0; x < waveform.Length; x++)
            {
                for (int y = 0; y <= waveform[x] * h1; y++)
                {
                    tex.SetPixel(x, h2 + y, col);
                    tex.SetPixel(x, h2 - y, col);
                }
            }
        ...
        public static void DrawTimeMarkerLine(this Texture2D tex, Vector2 p1, Vector2 p2, Color clr)
        {
            Vector2 t = p1;
            ...
            while ((int)t.x != (int)p2.x || (int)t.y != (int)p2.y)
            {
                ...
                ctr += frac;
                tex.SetPixel((int)t.x, (int)t.y, clr);
            }
